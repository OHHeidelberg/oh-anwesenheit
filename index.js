...
<style>
  ...
  .grid { 
    ...
    padding: 10px 5px 30px 5px; /* Unten mehr Padding für die Tooltips der letzten Reihe */
  }
  ...
  /* Tooltip nach UNTEN öffnen, damit er in Reihe 1 nicht abgeschnitten wird */
  .tooltip {
    visibility: hidden;
    position: absolute;
    top: 110%;
...
async function getFullStatus(id) {
    ...
    try {
        ...
        else if (lowTxt.includes("urlaub")) { res.c="bg-away"; r:7, res.e="🌴"; }
        return res;
    ...
    res.send(`<html>${htmlHead}<body>${styles}
        <div class="container">
            <div class="nav-bar">
                ...
                <a href="https://forms.gle/ServerProblemBeispielURL" target="_blank" class="nav-btn" style="border-color: #ff453a;">⚠️ Serverproblem</a>
